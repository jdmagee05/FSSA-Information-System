...
<body>
	...
	<form action="" method="post" id="add_member">
     <div id="wrapper">
     <h3 align="center">Add a Member to the Society</h3>
		<div id="first">
			...
			<label>Birth Place:</label><input type="text" name="birthplace"><br>
		...
		<div id="second">
			...
			<label>Date Applied:</label><input type="date" name="dateapplied"><br>
			<label>Date Approved:</label><input type="date" name="dateapproved"><br>
			<label>Date Inducted:</label><input type="date" name="dateinducted"><br>
		</div>
		</div>
		<div align="center">
